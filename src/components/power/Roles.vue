            ...
            <!-- 展开列 -->
                <el-table-column type="expand" >
                    <template slot-scope="scope" >
                        <el-row  :class=" ['bdbottom' , index === 0 ? 'bdtop' : '' ,'vcenter' ] " :key="item1.id" v-for ="(item1, index) in scope.row.children" >
                            <el-col :span="5" >
                                <el-tag
                                 closable
                            ...
                            <el-col :span="19" >
                                <el-row  :class=" [ index1 === 0 ? '' : 'bdtop' , 'vcenter'] " :key="item2.id" v-for ="(item2, index1) in item1.children" >
                            <el-col :span="6" >
                                <el-tag type="success" 
                                closable
